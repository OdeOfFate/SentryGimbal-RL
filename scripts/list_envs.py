...
All the environments are registered in the `sentry_gimbal` extension. They start
...
import sentry_gimbal.tasks  # noqa: F401


def main():
    """Print all environments registered in `sentry_gimbal` extension."""
